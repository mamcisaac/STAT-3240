...
# rgl::movie3d(rgl::spin3d(axis = c(0, 1, 0)), duration = 12, dir=here("img"), movie="transformed_clothing_food_income_secondorder", convert=TRUE)
```
...
.center[
![transformed_clothing_food_income_secondorder.gif](`r here("img", "transformed_clothing_food_income_secondorder.gif")`)
]
...
# rgl::movie3d(rgl::spin3d(axis = c(0, 1, 0)), duration = 12, dir=here("img"), movie="additive_model_surface", convert=TRUE)
```
...
.center[
![additive_model_surface.gif](`r here("img", "additive_model_surface.gif")`)
]
...
# rgl::movie3d(rgl::spin3d(axis = c(0, 1, 0)), duration = 12, dir=here("img"), movie="additive_model_surface2", convert=TRUE)
```
...
.center[
![additive_model_surface2.gif](`r here("img", "additive_model_surface2.gif")`)
]
...
# rgl::movie3d(rgl::spin3d(axis = c(0, 1, 0)), duration = 12, dir=here("img"), movie="reinforcement_interaction_model_surface", convert=TRUE)
```
...
.center[
![reinforcement_interaction_model_surface.gif](`r here("img", "reinforcement_interaction_model_surface.gif")`)
]
...
# rgl::movie3d(rgl::spin3d(axis = c(0, 1, 0)), duration = 12, dir=here("img"), movie="additive_model_surface3", convert=TRUE)
```
...
.center[
![additive_model_surface3.gif](`r here("img", "additive_model_surface3.gif")`)
]
...
# rgl::movie3d(rgl::spin3d(axis = c(0, 1, 0)), duration = 12, dir=here("img"), movie="interference_interaction_model_surface", convert=TRUE)
```
...
.center[
![interference_interaction_model_surface.gif](`r here("img", "interference_interaction_model_surface.gif")`)
]
...
xyplot(clothing_expenditure~age_group, data=spending_subset, type=c("p", "smooth"))
```
]
