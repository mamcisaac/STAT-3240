...
```{r}
predict_adjust(model_infection, newdata=data.frame(infection_risk=c(5, 5.5, 6)), interval="confidence", method="wh", alpha=.05)
```
...
```{r}
predict_adjust(model_infection, newdata=data.frame(infection_risk=c(5, 5.5, 6)), interval="confidence", method="bonferroni", alpha=.05)
```
