...
```{r}
ci.reg(model_infection, newdata=data.frame(infection_risk=c(5, 5.5, 6)), type="w", alpha=.05)
```
...
```{r}
ci.reg(model_infection, newdata=data.frame(infection_risk=c(5, 5.5, 6)), type="b", alpha=.05)
```
