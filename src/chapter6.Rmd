...
# rgl::movie3d(rgl::spin3d(axis = c(0, 1, 0)), duration = 12, dir=here("img"), movie="clothing_food_income", convert=TRUE)
```
...
.center[
![clothing_food_income.gif](`r here("img", "clothing_food_income.gif")`)
]
