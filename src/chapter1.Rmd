...
### In your opinion, why are you being required to complete pre-lecture readings and Warm Up exercises for STAT 3240?
<!-- PUT SELECT WARM UP RESPONSES HEREHERE (preceded by a ">"): -->
<!-- warm up question introduction) 1 -->

* To have better understanding of the content before class, to make it easier to follow through the class and learn more efficiently
* We can learn some simple knowledge by ourselves, and learn complex parts during the class. spend time wisely
* To ensure the lectures don't waste time going over material we can already know and to ensure the Moodle quiz program is working properly.
...
<!-- PUT SELECT WARM UP RESPONSES HEREHERE (preceded by a ">"): -->
<!-- warm up question introduction) 2 -->


* In the syllabus, it is mentioned that peer discussion will occur during class. Will this happen in pairs or in small groups? Will this be a time when the professor speaks individually to each group?
*  I'm planning to buy the book tomorrow.
* By reading the course syllabus, I think the in class interaction through socrative is most interesting. I think this police could give us a feedback to show the level of understanding of knowledge in real time.
* I am wondering if I could the 3rd edition of the textbook? Is there any difference?
