...
* Not to be lost in the class and have adequate knowledge of concept prior the class to clarify doubts.

* Because the time in class is not enough to cover every aspect of the course in-depth, so this method will allow us to properly go over tough parts of the course during the little time we have.
...
* The grading part, I didn’t really understand the passing threshold policy.

* From the syllabus what I found interesting was we will have a long term group project that will count 20% towards the grade. I'm curious to know what kind of project it is.

* I'm just asking about where to get the compulsory textbook for the course.
...
The Canadian Survey of Household Spending is carried out annually across Canada: https://www.statcan.gc.ca/en/survey/household/3508
